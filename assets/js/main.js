            ...
            .then(data => {
                ...
                data.forEach(project => {
                    ...
                    if (project.websiteLink && project.websiteLink.trim() !== '') {
                        websiteIconLink = `
                            <a href="${project.websiteLink}" target="_blank" class="project-link" title="Visit Live Website">
                    ...
                    if (project.tags && project.tags.length > 0) {
                        ...
                        project.tags.forEach(tag => {
                            tagsHtml += `<span class="tag tag-slate">${tag}</span>`;
                        });
                        tagsHtml += '</div>';
                    }

                    article.innerHTML = `
                        <div class="project-cover ${project.coverColor}">
                            <h3>${project.shortTitle || project.title}</h3>
                        </div>
                        <div class="project-body">
                            <div class="project-top">
                                <h3 class="outfit-font">${project.title}</h3>
                                <div style="display: flex; gap: 0.5rem; align-items: center;">
                                    ${websiteIconLink}
                                    <a href="${project.githubLink}" target="_blank" class="project-link" title="View Source">
